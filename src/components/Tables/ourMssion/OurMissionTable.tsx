...
import { createOurMission, updateOurMission } from '../../../api-calls/apicalls';


function OurMissionTable({ ourMissionData }: any) {

    const [oms, setOms] = useState<any[]>(ourMissionData);
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav className="flex justify-center items-center  gap-5 w-[40%]">
          ...
          <ol className="flex items-center gap-2">
            ...
            <li className="font-medium text-primary">Our Mission Management</li>
          </ol>
        </nav>
      </div>
