...
import AddIconBg from '../../../images/AddIcon2.jpg';
...
function ProductTable({
  ...
  const handelOnChange = (file: any) => {
    ...
    fileData.onload = (result) => {
      setPreviewFile(result.target && result.target.result);
    };
  };
  ...
  const handleOutsideClick = (e: any) => {
    if (
      productCatInputRef.current &&
      !productCatInputRef.current.contains(e.target)
    ) {
      setShowProductCatDropdown(false);
    }
    if (
      fileTempInputRef.current &&
      !fileTempInputRef.current.contains(e.target)
    ) {
      setShowFileTempDropdown(false);
    }

    if (
      quizTempInputRef.current &&
      !quizTempInputRef.current.contains(e.target)
    ) {
      setShowQuizTempDropdown(false);
    }

    if (
      mcqTempInputRef.current &&
      !mcqTempInputRef.current.contains(e.target)
    ) {
          ...
          <div className="shadow-md p-4 w-[50%] rounded-md dark:border-strokedark dark:bg-boxdark border-stroke bg-white overflow-y-auto max-h-full">
            ...
            <div className=" mt-4">
              <div className="flex flex-col justify-start items-start gap-3">
                ...
                <div className="dropdown w-full" ref={productCatInputRef}>
                  <input
                    type="text"
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
            ...
            <div className="mt-4">
              ...
              /> */}
              <div className="h-44 w-full rounded-md my-2 relative overflow-hidden">
                <img
                  src={previewFile ? previewFile : AddIconBg}
                ...
                <div className="absolute top-0 left-0 z-10 w-full h-full flex justify-center items-center">
                  <input
                    onChange={(e: any) => {
                      handelOnChange(e.target.files[0]);
                      //   setProductImage(e.target.files[0]);
                    }}
                    type="file"
                    hidden
                  ...
                  <button
                    ...
                    className="h-10 w-10 bg-white rounded-full shadow-md text-black flex justify-center items-center"
                  >
            ...
            <div className="mt-4">
              <div className="flex flex-col justify-start items-start gap-3">
                ...
                <div className="dropdown w-full" ref={fileTempInputRef}>
                  <input
                    type="text"
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  ...
                  {showFileTempDropdown && (
                    ...
                    >
                      {fileTemplates &&
                        fileTemplates.map((file: any, _: any) => (
                          <li>
                            <a
                              className="dropdown-item"
                              href="#"
                              onClick={(e: any) => {
                                let tempSelectedFileTemp: any =
                                  selectedFileTemplates;
                                for (let temp of tempSelectedFileTemp) {
                                  if (
                                    temp?.template_name == file?.template_name
                                  ) {
                                ...
                                setSelectedFileTemplates([
                                  ...tempSelectedFileTemp,
                                ]);
                                setShowFileTempDropdown(false);
                              }}
                            >
            ...
            <div className="mt-4">
              {selectedFileTemplates &&
                selectedFileTemplates.map((file: any, ind: any) => (
            ...
            <div className="mt-4">
              <div className="flex flex-col justify-start items-start gap-3">
                ...
                <div className="dropdown w-full" ref={quizTempInputRef}>
                  <input
                    type="text"
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  ...
                  {showQuizTempDropdown && (
                    ...
                    >
                      {quizTemplates &&
                        quizTemplates.map((quiz: any, _: any) => (
                          <li>
                            <a
                              className="dropdown-item"
                              href="#"
                              onClick={(e: any) => {
                                let tempSelectedQuizTemp: any =
                                  selectedQuizTemplates;
                                ...
                                setSelectedQuizTemplates([
                                  ...tempSelectedQuizTemp,
                                ]);
                                setShowQuizTempDropdown(false);
                              }}
                            >
            ...
            <div className="flex mt-3">
              {selectedQuizTemplates &&
                selectedQuizTemplates.map((quiz: any, ind: number) => (
                  <div className="ms-3" style={{ width: '15%' }}>
                    <div className="flex justify-end">
                      <CloseRounded
                        style={{ cursor: 'pointer', color: 'red' }}
            ...
            <div className="mt-4">
              <div className="flex flex-col justify-start items-start gap-3">
                ...
                <div className="dropdown w-full" ref={mcqTempInputRef}>
                  <input
                    type="text"
                    className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  ...
                  {showMcqTempDropdown && (
                    ...
                    >
                      {mcqTemplates &&
                        mcqTemplates.map((mcq: any, _: any) => (
                          <li>
                            <a
                              className="dropdown-item"
                              href="#"
            ...
            <div className="flex mt-3">
              {selectedMcqTemplates &&
                selectedMcqTemplates.map((mcq: any, ind: any) => (
                  <div className="ms-3" style={{ width: '15%' }}>
                    <div className="flex justify-end">
                      <CloseRounded
                        style={{ cursor: 'pointer', color: 'red' }}
                    ...
                    <div className="flex justify-center">{mcq?.paper_name}</div>
                  </div>
                ))}
            </div>
