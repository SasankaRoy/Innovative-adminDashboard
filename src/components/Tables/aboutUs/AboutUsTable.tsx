...
import { createAboutUs, updateAboutUs } from '../../../api-calls/apicalls';


function AboutUsTable({ aboutUsData }: any) {
  const [aus, setAus] = useState<any[]>(aboutUsData);
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav className="flex justify-center items-center  gap-5 w-[40%]">
          ...
          <ol className="flex items-center gap-2">
            ...
            <li className="font-medium text-primary">About Us Management</li>
          </ol>
        </nav>
      </div>
