            ...
            <div className="flex flex-col justify-start items-start gap-2 w-full">
              ...
              <div className="relative w-full h-44 rounded-md overflow-hidden">
                <input
                  ref={imageRef}
                  onChange={(e: any) => {
                    handelPreviewImg(e.target.files[0]);
...
const ConfirmDeleteModel = ({
  ...
  const handleDelete = async (id:any)=>{
    ...
    const requestToDelete = await deleteServices({service_id:id});
  ...
  return (
    <>
      <div className="fixed flex justify-center items-center left-0 top-0 w-full h-full backdrop-blur-md EditModelZindex">
        <div className="shadow-md p-4 w-[95%] xl:w-[50%] rounded-md dark:border-strokedark dark:bg-boxdark border-stroke bg-white overflow-y-auto max-h-full">
          <div className="flex justify-between items-center">
            <h2 className="text-[800] text-3xl ">
              Confrim Delete <span className="text-red-500">!!!!</span>
            </h2>
            <button
              onClick={() => {
                // handleClose();
          ...
          <p className="text-lg my-3 text-black dark:text-white">
          ...
          <div className="flex justify-end items-center gap-5">
            ...
            <button
              onClick={() => handleDelete(confirmDeleteModel.isDeletedID)}
              className="flex w-[15%] justify-center rounded-lg bg-primary p-3 font-medium text-gray hover:bg-opacity-90"
            >
              {isLoading ? (
                <CircularProgress className="text-base" color="inherit" />
