...
const TableThree = ({pagetitle}:any) => {
  ...
  return (
    <>
      ...
      {isCreateModel && (
        <CreateModel setIsCreateModel={setIsCreateModel} pagetitle={pagetitle} />
      )}
    </>
  );
};
...
// const CreateTemplateModel = ({ setIsCreateModel }: any) => {
//   const [isAddMCQ, setIsAddMCQ] = useState(false);
//   const [optionType, setOptionType] = useState('text');

//   const handleOptionChange = (e: { target: { checked: any; value: any } }) => {
...
//                         <div className="dark:border-form-strokedark dark:bg-[#313d4a] dark:text-white cursor-pointer shadow-md h-12 w-12 rounded-full flex justify-center items-center ">
