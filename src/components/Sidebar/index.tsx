    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className='flex justify-center items-center gap-3'>
          ...
          <h2 className='text-white text-3xl font-[600]'>Innovative</h2>
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/mcq-template-editor"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('mcq') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/choose-us"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('choose-us') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/partner-management"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('partner') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >                  
                  Partners Management
                </NavLink>
              ...
              <li>
                <NavLink
                  to="/testimonial"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('testimonial') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
