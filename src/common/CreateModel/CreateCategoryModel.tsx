...
export const CreateCategoryModel = ({ setIsCreateModel, pagetitle }: any) => {
  return (
      ...
      <div className="shadow-md p-4 w-[50%] rounded-md dark:border-strokedark dark:bg-boxdark border-stroke bg-white overflow-y-auto max-h-full">
        ...
        <div className="flex flex-col justify-start items-start gap-4 mt-5">
          ...
          <div className="flex justify-start items-start flex-col gap-3 w-full">
            ...
            <div className="relative h-44 w-[80%] mx-auto overflow-hidden rounded-md">
              ...
              <div className="absolute top-0 left-0 z-10 w-full h-full flex justify-center items-center">
                <button className="h-12 w-12 rounded-full flex justify-center items-center cursor-pointer dark:border-x-form-strokedark dark:bg-[#313d4a] dark:text-white">
