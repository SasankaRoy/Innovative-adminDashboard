...
export const UpdateTrainingModel = ({ setIsCreateModel, pagetitle }: any) => {
  return (
        ...
        <div className="flex flex-col justify-start items-start gap-4 w-full">
          ...
          <div className="flex flex-col justify-start items-start gap-3 w-full">
            ...
            <div className="relative h-44 w-[80%] mx-auto overflow-hidden rounded-md  fle">
              ...
              <img src={AddIcon} className="absolute top-0 left-0 w-full h-full object-cover" alt="selected-file-preview"/>
          ...
          <div className='flex flex-col justify-start items-start gap-3 w-full'>
            <label className='text-lg text-black dark:text-white'>Hover Title</label>

            <input type='text' placeholder='Enter Hover Title...' className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />

          </div>
          <div className='flex flex-col justify-start items-start gap-3 w-full'>
            <label className='text-lg text-black dark:text-white'>Hover Description</label>

            <textarea rows={4} placeholder='Enter Hover Description...' className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"></textarea>
          </div>
